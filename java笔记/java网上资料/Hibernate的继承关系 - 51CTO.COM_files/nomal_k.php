...
document.write('<input type="hidden" name="artID" value="133256" />');
document.write('<input type="hidden" name="referer" value="http://developer.51cto.com/art/200907/133256.htm" />');
